  ...
  return (
    <section className="w-screen h-screen flex flex-col items-center">
      ...
      >
        ...
        <div className="animate-pulse flex flex-col items-center gap-4 absolute top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-sm md:text-3xl font-bold">
          <span>안녕하세요!</span>
